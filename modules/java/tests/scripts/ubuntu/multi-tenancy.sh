...
bash ../java-test.sh -v 7 -u 76 -m 2 | tee -a results.txt

# 7 upgrade to 8
puppet apply --parser=future ../../java8_31_default_multi.pp
bash ../java-test.sh -v 8 -u 31 -m 3 | tee -a results.txt

# 8 downgrade to 6
puppet apply --parser=future ../../java6_45_default_multi.pp
bash ../java-test.sh -v 6 -u 45 -m 3 | tee -a results.txt
...
# 8 downgrade to 7
puppet apply --parser=future ../../java7_76_default_multi.pp
bash ../java-test.sh -v 7 -u 76 -m 3 | tee -a results.txt
