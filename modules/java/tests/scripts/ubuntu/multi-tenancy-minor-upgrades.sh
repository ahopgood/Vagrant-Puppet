...
<< --MULTI-LINE-COMMENT--
Testing strategy with multiple tenancy for minor versions of Java:
...
puppet apply --parser=future ../../java6_34_default_multi.pp
...
puppet apply --parser=future ../../java7_80_default_multi.pp
bash ../java-test.sh -v 7 -u 80 -m 2 | tee -a $RESULTS_FILE
...
puppet apply --parser=future ../../java8_112_default_multi.pp
bash ../java-test.sh -v 8 -u 112 -m 3 | tee -a $RESULTS_FILE
